                ...
                <div style={{ flexGrow: 1, paddingLeft: 20 }}>
                    ...
                    <div>
                        <Input
                            ...
                            onChange={(e) =>
                                setQuantity(
                                    Math.min(Number(e.target.value), 10000)
                                )
                            }
                        />
                    </div>
            ...
            <h2>
                ...
                {wallet.connected ? (
                    wallet.checkingBalance ? (
                        ...
                        <span
                            style={{
                                color: wallet.WETH < status.amount ? 'red' : '',
                            }}
                        >
                            {Number(wallet.WETH.toFixed(6)) +
                                ' WETH ' +
                                (wallet.WETH < status.amount
