  ...
  return (
    <div
      className={classNames(styles[prefixCls], {
        [styles[`${prefixCls}-normal`]]: !simple,
        [styles[`${prefixCls}-simple`]]: simple,
      })}
    >
      {simple ? null : (
        <div className={styles[`${prefixCls}-loop`]}>
          ...
          <Submit
            className={styles[`${prefixCls}-signup`]}
      ...
      <div
        className={classNames(styles[`${prefixCls}-community`], {
          [styles[`${prefixCls}-center`]]: simple,
        })}
      >
        ...
        <div className={styles[`${prefixCls}-brand`]}>
          ...
          <a href="#">
            <img
              className={styles[`${prefixCls}-icon-studio`]}
